...
using DocumentDBWebAppSample.Models;
using DocumentDBWebAppSample.Providers;
using DocumentDBWebAppSample.Results;
...
namespace DocumentDBWebAppSample.Controllers
{
    [Authorize]
